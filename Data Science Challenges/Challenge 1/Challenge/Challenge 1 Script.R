...
ggsave("goose_plot.png", goose_plot, path = "Challenge/Plots", units = "cm", width = 20, height = 15) #saves the plot at set dimensions to the Plots folder
...
ggsave("goose_map.png", goose_map, path = "Challenge/Plots", units = "cm", width = 20, height = 15)


#Panel of both plots
(goose_grid <- grid.arrange(goose_plot, goose_map, ncol = 2))
ggsave("goose_grid.png", goose_grid, path = "Challenge/Plots", units = "cm", width = 30, height = 15) #saves the plot at set dimensions to your WD
